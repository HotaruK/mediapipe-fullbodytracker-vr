...
def calibrate(landmarks):
    ...
    # 身長に基づいてスケールを調整
    actual_height = (landmarks[mp_pose.PoseLandmark.LEFT_FOOT_INDEX.value].y + landmarks[
        mp_pose.PoseLandmark.RIGHT_FOOT_INDEX.value].y) / 2 - \
                    (landmarks[mp_pose.PoseLandmark.LEFT_HIP.value].y + landmarks[
